...
class Cichlids_preTrain_Exp:
    def __init__(self, tank_ID, max_pretraining_days, max_sessions_per_day, success_threshold, unfit_threshold, max_session_duration, session_interval, max_trial_per_session, display_neutral_after_time, stimulus_image, neutral_image, ROC1_x1, ROC1_y1, ROC1_x2, ROC1_y2, start_x1, start_y1, start_x2, start_y2):
    ...
    def run_pretrain_exp(self):
        ...
        if day < self.max_pretraining_days:
            time.sleep(12*3600)   #Sleep for 12 hours to simulate passage of day else:
