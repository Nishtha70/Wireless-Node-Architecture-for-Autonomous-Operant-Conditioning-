...
class Cichlids_preTrain_Exp:
    def __init__(self, tank_ID, max_pretraining_days, max_sessions_per_day, stimulus_display_time, success_threshold, max_session_duration, session_interval, max_sessions_pretraining, max_trial_per_session, display_neutral_after_time, stimulus_image, neutral_image, ROC1_x1, ROC1_y1, ROC1_x2, ROC1_y2, start_x1, start_y1, start_x2, start_y2):
        self.tank_ID = tank_ID
        self.max_pretraining_days = max_pretraining_days
        self.max_sessions_per_day = max_sessions_per_day
        self.stimulus_display_time = stimulus_display_time
        self.success_threshold = success_threshold
        self.unfit_threshold = unfit_threshold
        self.max_session_duration = max_session_duration
        self.session_interval = session_interval
        self.max_sessions_pretraining = max_sessions_pretraining
    ...
    def run_pretrain_exp(self):
        ...
        for day in range(self.max_pretraining_days):
            
            for session in range(self.max_sessions_per_day):
                
                date_session = date.today()
                print('****')
                save_recording = "P" + "_" + str(self.tank_ID)  + "_" + str(date_session) + "NIS"+ ".avi"
